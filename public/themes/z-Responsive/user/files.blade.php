          ...
          <div class="panel-heading">
            ...
            <div class="col-md-12 " style="margin: 5px 0px">
                <div class="col-md-6" style="padding-left: 0px">
                    <p class="align-right">
                        <a id="delete_all" style="float: left !important;" class="confirm btn btn-danger btn-md">
...
$(document).ready(function(){
    ...
    // Delete All OK/Cancel Question
    $("#delete_all").click(function() {

        (new FrontBox).yes_no("are you sure you want to delete all file ?",
            "<i class='fa fa-trash'></i> Confirm File Delete").callback(function(btn){

            if(btn == 'yes' ){
                $.ajax({

                    url: window.location+'/deleteAll',
                    type: 'DELETE',
                    dataType: "JSON",
