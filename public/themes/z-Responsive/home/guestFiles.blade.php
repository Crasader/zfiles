...
{{ ((($data['guestFiles']->getCurrentPage() - 1)* $data['guestFiles']->getPerPage()) + $key+1) }}
    ...
    {{ HTML::script('public/themes/z-Responsive/assets/js/tables.min.js') }}
    {{ HTML::script('public/themes/z-Responsive/assets/js/jquery.frontbox-1.1.js') }}
{{ HTML::script('public/themes/z-Responsive/assets/js/multiple-emails.js') }}
