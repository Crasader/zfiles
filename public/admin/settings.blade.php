                 ...
                 <div class="btn-group" data-toggle="buttons">
                    ...
                    <div class="form-group">
                        ...
                        <div class="btn-group" data-toggle="buttons">
                            ...
                            <label class="btn btn-primary <?php echo ($data['settings']->confirm_email ==  1 ? 'active' : '')?>
                                    ">
                                <input name="confirm_email" type="radio" value="1" id="site_status"
                                <?php echo ($data['settings']->confirm_email ==  1 ? 'checked="checked" ' : '')?> >
                                <i class="fa fa-globe"></i>
                                Yes
                            </label>

                            <label class="btn btn-primary <?php echo ($data['settings']->confirm_email ==  0 ? 'active' : '')?>
                                    ">
                                <input name="confirm_email" type="radio" value="0" id="site_status"
                                <?php echo ($data['settings']->confirm_email ==  0 ? 'checked="checked" ' : '')?> >
                                <i class="fa fa-power-off"></i>
                                No
                            </label>
